        ...
        <div class="banner1" >
            ...
            <div class="container-fluid">
                <form action="" method="POST">
                   <center> <div class="row" > 
                    ...
                    <center><button type="submit" class="btn btn-primary" name="submit">Book</button>
                    <a href="deletebooking.php?id=<?php echo $id ?>"><button class="btn btn-primary" name="submit">Cancel Booking</button></a></center>
            ...
            if(isset($_POST['submit'])){
                ...
                foreach ($seats as $item){
                    //echo $item . "<br/>";
                    $query="insert into book(seat_no,movie_name,username) values ('$item','$moviename','$username')";
